...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("MYX");
    case mBTC: return QString("mMYX");
    case uBTC: return QString::fromUtf8("μMYX");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("Monyxs"));
    case mBTC: return QString(QObject::tr("Milli-Monyxs (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-Monyxs (1 / 1,000,000)"));
    default: return QString("???");
    }
}
