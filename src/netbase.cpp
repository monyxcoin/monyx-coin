...
bool Lookup(const char *pszName, std::vector<CService> &vAddr, uint16_t portDefault, bool fAllowLookup,
...
bool CNetAddr::IsRoutable() const {
    return IsValid() &&
           !(IsRFC1918() || IsRFC3927() || IsRFC4862() || (IsRFC4193() && !IsTor() && !IsI2P()) || IsRFC4843() ||
             IsLocal());
}
